...
#filename = 'messi.mp4'
# filename = 'suarez.mp4'
filename = 'pexels-anastasia-shuraeva-9517748.mp4'
filename = 'pexels-yaroslav-shuraev-7957503.mp4'
filename = 'pexels-pavel-danilyuk-8087320.mp4'
filename = 'pexels-ron-lach-9479128.mp4'
    ...
    if VISUAL:
        ...
        if save_video:
            ...
            if video_writer is None:
                ...
                video_writer = cv2.VideoWriter('output3.avi', fourcc, video_framerate, (plot_img.shape[1], plot_img.shape[0]))
